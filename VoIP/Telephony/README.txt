...
### Description
This lab demonstrates configuring a Cisco network with integrated **VoIP telephony**, **automatic IP addressing via DHCP**, and **secure remote management via SSH**.  
...
### Tools Used
- Cisco Packet Tracer
- Router (Cisco 2811/2911 with telephony capability)
- Switches
- IP Phones
- PCs
...
- Configured ephone-dns and ephones for IP phone registration.
